import sqlite3
from flask import Flask,request,g,render_template,send_file,redirect,url_for,send_from_directory
DATABASE='/var/www/html/example.db'
app=Flask(__name__)
...
@app.route('/responsePage',methods=['GET','POST'])
def responsePage(firstname,lastname,email,count):
        return """First Name : """ + str(firstname)+ """ <br> LastName :"""+str(lastname)+"""<br>Email:"""+str(email)+"""<br> Word Count: """+str(count)+"""<br><br><a href="/download" >Download</a>"""
